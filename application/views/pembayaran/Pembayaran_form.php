              ...
              .select2{width:100% !important};
                ...
                <div class="col-xs-12 col-md-6">
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                	    ...
                	    <div class="form-group">
                            <label for="int">Nama Peserta <span style="color:red;">*</span> <?php echo form_error('id_formulir') ?></label>
                            <?php if ($button=="Tambah") { ?>                     
                                <select type="text" class="select2 form-control" name="id_foormulir" id="id_formulir" placeholder="Nama Peserta" value="" required />
                                    <option value="">Pilih Nama Peserta</option> 
                                    <?php foreach ($formulir as $key => $value) { ?>
                            ...
                            <?php } else { ?>
                                <input type="hidden" class="form-control" name="id_foormulir" id="id_formulir" placeholder="ID User" value="<?php echo $id_formulir; ?>" readonly/>                                    
                                <input type="text" class="form-control" name="nama_peserta" id="nama_peserta" placeholder="Nama Peserta" value="<?php echo $nama_peserta; ?>" readonly/>                  
                            <?php } ?>   
                        </div>
                	    <div class="form-group">
