                  ...
                  <div class="col-xs-12 col-md-4">
                    ...
                    <div class="row">                     
                      ...
                      <div class="col-xs-12 col-md-3">                    
                        ...
                        <div class="form-group">                      
                          <input type="checkbox" name="id_paud" id="id_paud" value="Ya" <?php if ($formulir->id_paud=='Ya') { echo 'checked'; } ?>>&nbsp; Paud/TK
                        </div>
                        <div class="form-group">                      
                          <input type="checkbox" name="nm_paud" id="nm_paud" value="Ya" <?php if ($formulir->nm_paud=='Ya') { echo 'checked'; } ?>>&nbsp; Nama Paud/TK
                        </div>
                        <div class="form-group">                      
                          <input type="checkbox" name="seragam" id="seragam" value="Ya" <?php if ($formulir->seragam=='Ya') { echo 'checked'; } ?>>&nbsp; Seragam
                        </div>
