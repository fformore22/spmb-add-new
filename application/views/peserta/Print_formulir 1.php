...
<!-- 	<?php if ($formulir->no_kip=='Ya'){ ?>			
	...
	<?php if ($formulir->id_paud=='Ya'){ ?>			
		<tr> 	 
		    <td>Paud/TK</td>
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->id_paud ?></td>
		</tr>
	<?php } ?>	
	...
	<?php if ($formulir->nm_paud=='Ya'){ ?>			
		<tr> 	 
		    <td>Nama Paud/TK</td>
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->nm_paud ?></td>
		</tr>
	<?php } ?>	
	...
	<?php if ($formulir->seragam=='Ya'){ ?>			
		<tr> 	 
		    ...
		    <td>: </td>
		    <td style="border-bottom: 1px dotted"><?php echo $peserta->seragam ?></td>
		</tr>
	<?php } ?>	

    <?php if ($formulir->jalur=='Ya'){ ?>		  
		<tr>    
