    ...
    <div class="col-xs-12 col-md-12">
        <div class="box box-primary">
            ...
            <!-- end pilihan jurusan --> 
                ...
                <div class="form-group">
                    <label for="varchar">Kelurahan <span style="color:red;">*</span> <?php echo form_error('nama_kelurahan') ?></label>
                <?php if ($button=="Tambah") { ?>    
            ...
            <!-- end jarak titik sekolah ke rumah -->                   
                ...
                <div class="form-group">
                    <label for="varchar">Paud/TK <span style="color:red;">*</span> <?php echo form_error('id_paud') ?></label>  
                <?php if ($button=="Tambah") { ?>     
                    <select type="text" class="form-control" name="id_paud" id="id_paud" placeholder="Paud/TK"  value="" required/>
                        <option value="<?= set_value('id_paud') ?>"><?= set_value('id_paud') ?></option>
                ...
                <div class="form-group">
                    <label for="varchar">Ukuran Seragam <span style="color:red;">*</span> <?php echo form_error('seragam') ?></label>
            ...
            <?php } ?>                                         
                ...
                <div class="form-group">
                    <label for="varchar">Penrima KJP <?php echo form_error('status_daftar_ulang') ?></label>
                <?php if ($button=="Tambah") { ?>    
                    <select type="text" class="form-control" name="status_daftar_ulang" id="status_daftar_ulang" placeholder="Status Hasil" value="" />
                        <option value="Belum daftar ulang">Pilih</option>
                        <option value="Belum daftar ulang">Ya</option>
                        <option value="Menunggu">Tidak</option>
                    </select>
                <?php } else { ?>
                    <select type="text" class="form-control" name="status_daftar_ulang" id="status_daftar_ulang" placeholder="Status Hasil" value="" />
