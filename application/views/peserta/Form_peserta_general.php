        ...
        <?php if ($nomer->status=='Belum diverifikasi') { ?>
          ...
          <!-- end pilihan jurusan -->                                                    
            ...
            <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nisn" id="nisn"  onkeypress="return Angkasaja(event)" placeholder="NISN harus tepat 10 karakter" value="<?php echo $nisn; ?>" />
            </div>
            <?php } else { ?>
            <div class="form-group">
                  <label for="varchar">NISN <span style="color:red;">*</span> <?php echo form_error('nisn') ?></label>
                  <input type="text" class="form-control" name="nisn" id="nisn"  value="<?php echo $nisn; ?>" />
            </div>    
            <?php } ?>
            <?php } else { ?>
            ...
            <?php if ($formulir->id_paud=='Ya'){ ?>
            <div class="form-group">
                  <label for="varchar">Paud/TK <?php echo form_error('id_paud') ?></label>
                  <select type="text" class="form-control" name="id_paud" id="id_paud" value="" placeholder="Paud/TK" >
                          <option value="<?php echo $peserta->id_paud; ?>"><?php echo $peserta->id_paud; ?></option>
            ...
            <?php } else { ?>
                  <input type="hidden" class="form-control" name="id_paud" id="id_paud" />
            <?php } ?>
            
            <?php if ($formulir->nm_paud=='Ya'){ ?>
            <div class="form-group">
                  <label for="varchar">Nama Paud/TK <span style="color:red;">*</span> <?php echo form_error('nm_paud') ?></label>
                  <input type="text" class="form-control" name="nm_paud" id="nm_paud" value="<?php echo $nm_paud; ?>" placeholder="Nama Paud" required/>
            </div>
            <?php } else { ?>
                  <input type="hidden" class="form-control" name="nm_paud" id="nm_paud" />
            <?php } ?> 
            
            <?php if ($formulir->seragam=='Ya'){ ?>
            <div class="form-group">
                  <label for="varchar">Ukuran Seragam <?php echo form_error('seragam') ?></label>
                  <select type="text" class="form-control" name="seragam" id="seragam" value="" placeholder="Ukuran Seragam" >
                          <option value="<?php echo $peserta->seragam; ?>"><?php echo $peserta->seragam; ?></option>
                          <option value="">M</option>
                          <option value="Paud">L</option>
                          <option value="TK">XL</option>
                          <option value="Paud">XXL</option>
                          <option value="TK">XXXL</option>
                          <option value="Paud">XXXXL</option>
                          <option value="TK">JUMBO</option>
                  </select>
            </div>
            <?php } else { ?>
                  <input type="hidden" class="form-control" name="seragam" id="seragam" />
            <?php } ?>
