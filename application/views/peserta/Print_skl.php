...
<?php } ?>    
    ...
    <br>
 	<table>    
		...
		<tr>	
			<td colspan="3" style="text-align: center"><strong>PENERIMAAN PESERTA DIDIK BARU</strong></td>	    
        </tr>
		...
		<tr>	    
		    <td colspan="3" style="text-align: center"><br><br><br><br><br><br></td>
        </tr>        
    </table>
    <table class="word-table" style="margin-bottom: 10px">	
    	<tr>
            <td colspan="5" style="text-align: justify">Berdasarkan keputusan kepala <?php echo strtoupper($pengaturan->nama_sekolah) ?> tanggal <?php echo format_indo(date('Y-m-d', strtotime($peserta->tanggal_daftar))) ?> tentang penerimaan peserta didik baru tahun pelajaran <?php echo $peserta->tahun_pelajaran ?>/<?php echo $tp ?> menerangkan bahwa :</td>
        </tr> 
    	<tr>
            <td width="30px"></td>
    ...
    <br>
 	<table>    
		<tr>	
			...
			<td width="150px"></td>
			<td rowspan="3" width="100px" style="text-align: right"></td>  
			<td width="40px"></td>	    
		    <td>Jakarta, <?php echo format_indo(date('Y-m-d', strtotime($peserta->tanggal_daftar))) ?></td>
        </tr> 
		<tr>	
			<td></td> 
			<td></td>   
		    <td>Petugas,<br><br><br><br><br><br><br>
            </td>
        </tr>   
		<tr>
			<td></td>
