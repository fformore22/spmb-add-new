...
class Peserta extends CI_Controller
{
    ...
    public function create()
    {
	    $data = array(
			...
			'id_paud' => set_value('id_paud'),
			'nm_paud' => set_value('nm_paud'),
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
				...
				'id_paud' => $this->input->post('id_paud',TRUE),
				'nm_paud' => $this->input->post('nm_paud',TRUE),
    ...
    public function update($id)
    {
	    ...
	    if ($row) {
	        $data = array(
				...
				'id_paud' => set_value('id_paud', $row->id_paud),
				'nm_paud' => set_value('nm_paud', $row->nm_paud),
				'seragam' => set_value('seragam', $row->seragam),
    ...
    public function _rules()
    {
		...
		$this->form_validation->set_rules('id_paud', 'paud/tk', 'trim');
		$this->form_validation->set_rules('nm_paud', 'nama paud/tk', 'trim');
		$this->form_validation->set_rules('seragam', 'seragam', 'trim');
    ...
    public function excel()
    {
		...
		xlsWriteLabel($tablehead, $kolomhead++, "Paud/TK");
		xlsWriteLabel($tablehead, $kolomhead++, "Nama Paud/TK");
		xlsWriteLabel($tablehead, $kolomhead++, "Seragam");
	...
	foreach ($this->Peserta_model->get_all() as $data) {
		...
		xlsWriteLabel($tablebody, $kolombody++, $data->id_paud);
		xlsWriteLabel($tablebody, $kolombody++, $data->nm_paud);
		xlsWriteLabel($tablebody, $kolombody++, $data->seragam);
